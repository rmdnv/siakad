@extends('layout', ['title' => 'Create Question'])
    ...
    <form method="POST" action="{{ route('questions.store') }}" class="space-y-6">
        ...
        <div>
            ...
            <textarea name="text" rows="3" placeholder="Tulis pertanyaan di sini..."
                class="w-full border rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 focus:outline-none" required></textarea>
        </div>
        ...
        <div>
            ...
            <select name="type"
                ...
                <option value="checkbox">Pilihan Ganda Kompleks (checkbox)</option>
        ...
        <div id="options-section">
            ...
            <div id="options-wrapper" class="space-y-3"></div>
        ...
        <div>
            ...
            <div id="conditions-wrapper" class="space-y-3"></div>
...
<script>
    ...
    typeSelect.addEventListener('change', function() {
        if (this.value === 'radio' || this.value === 'checkbox') {
            ...
            optionsWrapper.innerHTML = ''; // reset kalau ganti ke text
        }
    });
